...
<body>
    <div class="container">
        ...
        <div class="row">
            ...
            <a href="registrarcoche.php?id_cliente=<?php echo $id_cliente; ?>" class="btn btn-primary">Registrar Coche</a>
        </div>
        <br><br>
        ...
        <table id="tabla" class="display" style="width:100%">
            ...
            <tbody>
                ...
                ?>
                        <td><a href="servicio.php?id_coche=<?php echo $fila['id_coche']; ?>&id_cliente=<?php echo $id_cliente; ?>" class="btn btn-primary">Servicio</a></td>
